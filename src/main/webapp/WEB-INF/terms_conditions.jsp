...
<body>
	...
	<div class="jumbotron jumbotron-fluid">
		<div class="jumbo_content" style="padding: 15px;">
			<h2>
			...
			<p>These terms and conditions outline the rules and regulations
				for the use of commUnity's Website, located at www.commUnity.com.</p>

			<p>
				By accessing this website we assume you accept these terms and
				conditions. Do not continue to use commUnity if you do not agree to
				take all of the terms and conditions stated on this page. Our Terms
				and Conditions were created with the help of the <a
					href="https://www.termsandconditionsgenerator.com">Terms And
					Conditions Generator</a> and the <a
					href="https://www.termsconditionsgenerator.com">Terms &
			...
			<p>We employ the use of cookies. By accessing commUnity, you
				agreed to use cookies in agreement with the commUnity's Privacy
				Policy.</p>
			...
			<p>Unless otherwise stated, commUnity and/or its licensors own
				the intellectual property rights for all material on commUnity. All
				intellectual property rights are reserved. You may access this from
				commUnity for your own personal use subjected to restrictions set in
				these terms and conditions.</p>

			<p>You must not:</p>
			<ul>
				<li>Republish material from commUnity</li>
				<li>Sell, rent or sub-license material from commUnity</li>
				<li>Reproduce, duplicate or copy material from commUnity</li>
				<li>Redistribute content from commUnity</li>
			</ul>
			...
			<p>Parts of this website offer an opportunity for users to post
				...
				website. commUnity does not filter, edit, publish or review Comments
				prior to their presence on the website. Comments do not reflect the
				views and opinions of commUnity,its agents and/or affiliates.
				...
				commUnity shall not be liable for the Comments or for any liability,
			...
			<p>commUnity reserves the right to monitor all Comments and to
				remove any Comments which can be considered inappropriate, offensive
				or causes breach of these Terms and Conditions.</p>
			...
			<p>You hereby grant commUnity a non-exclusive license to use,
				reproduce, edit and authorize others to use, reproduce and edit any
				of your Comments in any and all forms, formats or media.</p>
			...
			<p>We will approve link requests from these organizations if we
				...
				commUnity; and (d) the link is in the context of general resource
				information.</p>
			...
			<p>If you are one of the organizations listed in paragraph 2
				...
				us by sending an e-mail to commUnity. Please include your name, your
			...
			<p>No use of commUnity's logo or other artwork will be allowed
